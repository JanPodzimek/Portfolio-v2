...
const mainTools = [
  ...
  { name: 'Git', iconSrc: '/techIcons/git.png', description: 'I\'m a mid-level Git user with experience in creating commits, merging branches, and resolving conflicts. I’m comfortable working with common Git workflows in collaborative projects.' },
  ...
  return (
    ...
    >
      <FadeIn className="max-w-5xl mx-auto">
        <SectionTitle title="Technologies and tools I'm comfortable using" />
